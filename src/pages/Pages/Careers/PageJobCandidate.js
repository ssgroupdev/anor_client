              ...
              <Col lg="4" md="5" xs="12">
                <Card className="job-profile shadow border-0">
                  ...
                  <CardBody>
                    ...
                    >
                      <i className="mdi mdi-email"></i> Contact Me
                    </Link>
                  </CardBody>
                </Card>
              </Col>
                ...
                <div className="ml-lg-4">
                  ...
                  <Row>
                    {this.state.experiences.map((exp, key) => (
                      <Col key={key} lg="12" className="mt-4 pt-2">
                        <Media>
                          <div className="company-logo text-muted h6 mr-3 text-center">
                            <img
                              src={exp.image}
                  ...
                  <div className="mt-4 pt-2">
                    <Link to="#" className="btn btn-primary mr-2">
                      <i className="mdi mdi-account-check"></i> Hire me
                    </Link>
                    <Link to="#" className="btn btn-outline-primary ml-1">
                      <i className="mdi mdi-printer"></i> Print CV
                    </Link>
                  </div>
                </div>
              </Col>
