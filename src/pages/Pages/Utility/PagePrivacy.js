...
class PagePrivacy extends Component {
  constructor(props) {
    ...
    this.state = {
      pathItems: [
        ...
        { id: 4, name:  props.lang.lang.privacyPolicy },
      ],
    };
  }
  componentDidMount() {
  ...
  render() {
    const {privacyPolicy} = this.props.lang.lang
    return (
      <React.Fragment>
        {/* breadcrumb */}
        <PageBreadcrumb pathItems={this.state.pathItems}>
          <h4 className="title">{privacyPolicy}</h4>
...
export default connect(mstp,null)(PagePrivacy);
